...
class FLIPWaterMethod
{
    private:

        Grid _grid;

        FluidProjector _projection;
    ...
    public:
        ...
        void newParticle( Particles& pts, const Vec3f& p, const Vec3f& v )
        {
            ...
            {
                pts.position.initialize( 0, MemorySpace::kUnified );
                pts.velocity.initialize( 0, MemorySpace::kUnified );
                pts.vorticity.initialize( 0, MemorySpace::kUnified );
                pts.curvature.initialize( 0, MemorySpace::kUnified );
                pts.adjacency.initialize( 0, MemorySpace::kUnified );
