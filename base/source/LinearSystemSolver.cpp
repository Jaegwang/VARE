...
int
LinearSystemSolver::cg( const FloatSparseMatrix& A, FloatArray& x, FloatArray& b, const int max )
{
    FloatArray r, p, Ap;
...
int
LinearSystemSolver::pcg( const FloatSparseMatrix& A, FloatArray& M, FloatArray& x, FloatArray& b, const int max, const bool pre )
{
